...
export default function CreateProduct({userInfo}) {
  ...
  const handleOnchange = (e, index) => {
    if (image[index]) {
      image[index] = window.URL.createObjectURL(e.target.files[0]);
      ...
      <div className='add__pro-basic__infor'>
        ...
        <div className='add__pro-basic__infor-description'>
          ...
          <textarea
            ...
            cols='10'
            rows='5'
            className='add__pro-basic__infor-description-content'></textarea>
        </div>
      </div>
