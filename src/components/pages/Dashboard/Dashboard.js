          ...
          <div className="dashboard__top-left__layout">
            <div className="dashboard__top-left__layout-infor">
              <div className="dashboard__top-left__layout-text">
                <LocalMallIcon style={{ fontSize: "36px",marginRight:"10px", color:"#05B171" }} />
                <span>$10.552,40</span>
                <div className="layout-text__recent">
                  <ArrowUpwardIcon style={{ fontSize: "30px",marginLeft:"10px", color:"#05B171" }} />
                  <span>8.3%</span>
                </div>
              </div>
              <div className="dashboard__layout-selects">
                <select className="dashboard__layout-select">
                  ...
                  <option className="dashboard__layout-select__item" value="3">April</option>
                  <option className="dashboard__layout-select__item" value="5">June</option>
                  <option className="dashboard__layout-select__item" value="6">July</option>
                  <option className="dashboard__layout-select__item" value="7">August</option>
                  <option className="dashboard__layout-select__item" value="8">September</option>
                  <option className="dashboard__layout-select__item" value="9">October</option>
                  <option className="dashboard__layout-select__item" value="10">November</option>
                  <option className="dashboard__layout-select__item" value="11">December</option>
