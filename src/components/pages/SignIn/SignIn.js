    ...
    <div className="re_container">
      <div className="re_form">
        <div className="re_form_fr">
          ...
          <p style={{ color: "#8c8c8c", marginTop: -20 }}>
            Sign in to ekaf ekin to continue
          </p>
          <input
            required
          ...
          >
            ...
            <span style={{ color: "#ff6e40", marginLeft: 5 }}>
              Reset your password now.
            </span>
          </div>
          <div style={{ height: 50 }} />
          <p className="re_btn" onClick={() => handleSignin()}>
            Sign In
          </p>
        </div>
        <div
        ...
        <div className="re_form_sr">
          <p style={{ fontSize: 36, fontWeight: 530, color: "#ff6e40" }}>
            ekaf ekin
          </p>
          <p style={{ fontSize: 24, fontWeight: 600 }}>Welcome to ekaf ekin</p>
          <p style={{ fontSize: 18 }}>
            if you don't have an account, would you like{" "}
          </p>
