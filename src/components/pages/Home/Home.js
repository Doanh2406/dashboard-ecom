...
import { listProducts, listProductsCategory, listProductsPrice, listProductsSearch } from '../../redux/actions/productActions'
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    console.log(userInfo._id, sort, page === 1 ? 0 : page * count)
    dispatch(listProducts(userInfo._id, sort, (page - 1) * count))
  }, [dispatch, page, sort,count])
        ...
        data.loading ? <LoadingPage /> : <div className='h_container'>
          <div className='h_cl1'>
            ...
            <div className='h1_cl1_card_container'>
              ...
              <div className='h1_cl1_row1'>
                {
                  count > 8 && data.products.slice(6, 9).map((item, index) => {
                    return (
                      <Card key={index} data={item} />
                    )
                  })
              ...
              <div className='h1_cl1_row1'>
                {
                  count > 11 && data.products.slice(9, 12).map((item, index) => {
                    return (
                      <Card key={index} data={item} />
                    )
                  })
