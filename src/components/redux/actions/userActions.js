...
export const updateUser = (
  userId, name, userName, birth, sex, role, status, department, phone, website, addressline1, addressline2, city, country, language, postcode, twiter, facebook, instagram, zalo
) => async (dispatch) => {
  dispatch({
  ...
  try {
    const { data } = await Axios.put(`/api/users/${userId}`, { name, userName, birth, sex, role, status, department, phone, website, addressline1, addressline2, city, country, language, postcode, twiter, facebook, instagram, zalo })
    dispatch({
